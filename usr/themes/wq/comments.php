...
<div id="comments">
    ...
    <div id="<?php $this->respondId(); ?>" class="respond">
		...
		<div class="col1" >
                            ...
                            <textarea style="width:100%" rows="8" cols="50" name="text" class="textarea"><?php $this->remember('text'); ?></textarea>
            ...
            <p>
                ...
                <input type="url" name="url" id="url" class="text" placeholder="<?php _e('example.com  (选填)'); ?>" value="<?php $this->remember('url'); ?>" />
            </p>
